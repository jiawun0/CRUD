<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkCategoryFront.aspx.cs" Inherits="CRUD.LinkCategoryFront" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Text="連結種類前台"></asp:Label>
            <br />
