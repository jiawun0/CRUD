    ...
    <form id="form1" runat="server">
        <div>
            ...
            VideoName: <%--<asp:Label ID="AlbumNLabel" runat="server" Text='<%# Eval("AlbumName") %>' /><br />--%>
                ...
                <iframe width="560" height="315" src="<%# "https://www.youtube.com/embed/" +Eval("VideoIframe") %>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <br />
            ...
            <%# Container.ItemIndex % 3 == 2 || Container.ItemIndex == (Repeater_Video.Items.Count - 1) ? "</tr>" : "" %>
            </ItemTemplate>
            </asp:Repeater>
            </table>
        </div>
